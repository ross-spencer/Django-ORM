...
GOOD_GLOBAL_TYPES = (
    ...
    types.TypeType,
    types.ClassType,
    # django.db.models.base.ModelBase, TODO HARNESS: renable?
    logging.Logger,
    int,
    str,
    tuple,
    # django.conf.LazySettings, TODO HARNESS: renable?
    # django.db.DefaultConnectionProxy, TODO HARNESS: renable?
