...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'db_table': 'Jobs',
                'index_together': {('sipuuid', 'createdtime', 'createdtimedec'), ('sipuuid', 'jobtype', 'createdtime', 'createdtimedec'), ('jobtype', 'currentstep'), ('sipuuid', 'currentstep', 'microservicegroup', 'microservicechainlink')},
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.ForeignKey(db_column='fileUUID', on_delete=django.db.models.deletion.CASCADE, to='main.File')),
                ('rule', models.ForeignKey(db_column='ruleUUID', on_delete=django.db.models.deletion.CASCADE, to='fpr.FPRule', to_field='uuid')),
            ],
        ),
        migrations.CreateModel(
            name='FileID',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='pk', editable=False, primary_key=True, serialize=False)),
                ('file_uuid', models.ForeignKey(db_column='fileUUID', on_delete=django.db.models.deletion.CASCADE, to='main.File')),
                ('format_version', models.ForeignKey(db_column='fileID', on_delete=django.db.models.deletion.CASCADE, to='fpr.FormatVersion', to_field='uuid')),
            ],
            options={
